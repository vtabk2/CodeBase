...
//                Log.i(TAG, "onProductDetailsResponse: $responseCode $debugMessage")
                if (queryProductDetailsResult.productDetailsList.isEmpty()) {
...
//                Log.wtf(TAG, "onProductDetailsResponse: $responseCode $debugMessage")
    ...
    private fun queryProductDetailsAsync() {
        ...
        if (knownInAppProducts.isNotEmpty()) {
            ...
            billingClient.queryProductDetailsAsync(params) { billingResult, queryProductDetailsResult -> // Process the result
                onProductDetailsResponse(billingResult, queryProductDetailsResult)
            }
        }
