...
import com.core.ads.databinding.GntVersionV1Binding
...
class NativeInterstitialV1View @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : BaseNativeTemplateView(context, attrs, defStyleAttr) {


    private val binding: GntVersionV1Binding by lazy {
        GntVersionV1Binding.inflate(LayoutInflater.from(context), this)
    }
...
//        }
    ...
    private fun resetCloseCountDown() {
        ...
        binding.lnCountDown.visibility = VISIBLE
    ...
    private fun updateCountDownText(millis: Long) {
        ...
        binding.tvCountDownTime.text = context.getString(R.string.ads_countdown_time_format, seconds.toInt())
    }

    private fun resolveCountDownTheme(styles: NativeTemplateStyle): CountDownTheme {
        val colorString = styles.backgroundFullColor ?: styles.backgroundColor ?: return CountDownTheme.DARK
        val bgColor = runCatching { colorString.toColorInt() }.getOrNull() ?: return CountDownTheme.DARK
